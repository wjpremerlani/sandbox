...
const struct waypointDef waypoints[] = {
{ {   1500,   1500 , 500 } , F_NORMAL, CAM_VIEW_LAUNCH } ,
{ {     0 ,    1500 , 500 } ,  F_NORMAL, CAM_VIEW_LAUNCH } ,
{ {   -1500,   1500, 500 } , F_NORMAL + F_INVERTED , CAM_VIEW_LAUNCH } ,
{ {   -1500,   0, 500 } , F_NORMAL  + F_INVERTED  , CAM_VIEW_LAUNCH } ,
{ {   -1500,   -1500, 500 } , F_NORMAL, CAM_VIEW_LAUNCH } ,
{ {   0 ,   -1500, 500 } , F_NORMAL , CAM_VIEW_LAUNCH } ,
{ {   1500,   -1500, 500 } , F_NORMAL+ F_INVERTED , CAM_VIEW_LAUNCH } ,	
{ {   1500,   0, 500 } , F_NORMAL+ F_INVERTED , CAM_VIEW_LAUNCH } ,		
